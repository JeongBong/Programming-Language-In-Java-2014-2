...
abstract public class Unit {
	...
	public enum Identity {
		...
		WHITE_PLAYER(0), BLACK_PLAYER(1), 
		WHITE_KING(2), BLACK_KING(3), 
		WHITE_QUEEN(4), BLACK_QUEEN(5), 
		WHITE_ROOK(6), BLACK_ROOK(7),
		WHITE_BISHOP(8), BLACK_BISHOP(9),
		WHITE_KNIGHT(10),BLACK_KNIGHT(11),
		WHITE_PAWN(12), BLACK_PAWN(13);
	...
	boolean isValidPosition(Position position) {
		if ((position.getxPos()!=-1)&&(position.getyPos()!=-1)) return true;
		return false;
	}
